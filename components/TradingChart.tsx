        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              background: positionViewMode === 'cumulative' ? 'rgba(41, 98, 255, 0.1)' : 'transparent',
              color: positionViewMode === 'cumulative' ? ((themeMode === 'dark' || themeMode === 'black' || themeMode === 'blue') ? '#FFFFFF' : 'var(--navy, #101828)') : 'var(--text-secondary, #6b7280)',
              borderBottom: positionViewMode === 'cumulative' ? '2.5px solid #2962FF' : '2.5px solid transparent',
              marginBottom: '-2px',
          ...
          <button
            ...
            style={{
              ...
              border: 'none', borderRadius: 0, cursor: 'pointer',
              background: positionViewMode === 'detailed' ? 'rgba(41, 98, 255, 0.1)' : 'transparent',
              color: positionViewMode === 'detailed' ? ((themeMode === 'dark' || themeMode === 'black' || themeMode === 'blue') ? '#FFFFFF' : 'var(--navy, #101828)') : 'var(--text-secondary, #6b7280)',
              borderBottom: positionViewMode === 'detailed' ? '2.5px solid #2962FF' : '2.5px solid transparent',
              marginBottom: '-2px',
              transition: 'all 0.15s',
            }}
          >
