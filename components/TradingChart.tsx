        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              background: positionViewMode === 'cumulative' ? ((themeMode === 'dark' || themeMode === 'black' || themeMode === 'blue') ? 'rgba(41, 98, 255, 0.15)' : 'transparent') : 'transparent',
          ...
          <button
            ...
            style={{
              ...
              border: 'none', borderRadius: 0, cursor: 'pointer',
              background: positionViewMode === 'detailed' ? ((themeMode === 'dark' || themeMode === 'black' || themeMode === 'blue') ? 'rgba(41, 98, 255, 0.15)' : 'transparent') : 'transparent',
