...
export default function Page() {
  ...
  useEffect(() => {
    // Load the buysegment initialisation script from public/ to avoid
    // Turbopack treating the inline JS template literal as TypeScript.
  ...
  return (
    <div
      ...
      dangerouslySetInnerHTML={{ __html: [
        ...
        '  <div class="sheet-header"><div class="sheet-header-row"><div><div class="sheet-script-name" id="tradeScriptName">NIFTY FUT</div><span class="sheet-segment" id="tradeSegment">NSE - Futures</span></div><div class="sheet-cmp-area"><div class="sheet-cmp-label">CMP</div><div class="sheet-cmp-value" id="tradeCmpValue">0.00</div><div><span class="sheet-change" id="tradeChange">+0.00%</span></div></div></div></div>',
        '  <div class="sheet-bidask"><div class="sheet-bid"><div class="sheet-bidask-label">BID</div><div class="sheet-bid-value" id="tradeBid">0.00</div></div><div class="sheet-divider"></div><div class="sheet-ask"><div class="sheet-bidask-label">ASK</div><div class="sheet-ask-value" id="tradeAsk">0.00</div></div></div>',
        ...
        '      <div class="order-script-info"><div class="order-script-name" id="orderScriptName">NIFTY FUT</div><span class="order-segment" id="orderSegment">NSE - Futures</span></div>',
        '    </div>',
        ...
        '      <div class="order-bidask-mini"><div class="order-bidask-mini-item"><span class="order-bidask-mini-label">BID</span><span class="order-bid-value-mini" id="orderBid">0.00</span></div><div class="order-bidask-mini-item"><span class="order-bidask-mini-label">ASK</span><span class="order-ask-value-mini" id="orderAsk">0.00</span></div></div>',
        '    </div>',
        '  </div>',
        ...
        '    <div class="lot-info-row"><div class="lot-info-item"><span class="lot-info-label">Lot Size</span><span class="lot-info-value" id="lotSizeValue">50</span></div><div class="lot-info-item"><span class="lot-info-label">Max Lots</span><span class="lot-info-value" id="maxLotsValue">100</span></div><div class="lot-info-item"><span class="lot-info-label">Order Lots</span><span class="lot-info-value" id="orderLotsValue">1</span></div><div class="lot-info-item"><span class="lot-info-label">Total Qty</span><span class="lot-info-value" id="totalQtyValue">50</span></div></div>',
        ...
        '    <div class="type-section"><div class="section-label"><i class="fas fa-shopping-cart"></i> ORDER TYPE</div>',
        '      <div class="type-buttons"><button class="type-btn active" data-order-type="market">MARKET</button><button class="type-btn" data-order-type="limit">LIMIT</button><button class="type-btn" data-order-type="slm">SL-M</button><button class="type-btn" data-order-type="gtt">GTT</button></div>',
        ...
        '      <div class="brokerage-row" id="brokerageRow"><div style="display:flex;justify-content:space-between"><span class="margin-label">GTT Brokerage</span><span class="margin-value" id="brokerageAmount">0.00</span></div></div>',
        '    </div>',
    ...
    async function executeFinalOrder() {
        var lotSize = currentScript.lotSize || 1;
        var actualQty = currentIsLotMode ? currentQuantity * lotSize : currentQuantity;
        var price = currentScript.price;
        if (currentOrderType === 'limit') { var lp = parseFloat(document.getElementById('limitPriceInput')?.value); if (lp && lp > 0) price = lp; }
